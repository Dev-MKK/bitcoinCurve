...
class Curve {
    ...
    /***
     * returns the uncompressed Bitcoin address generated from the private key.
     *
     * @param string $derPubKey (hexa)
     * @return String (base58)
     */
    public function getAddress($compressed=false,$derPubKey = null)
    {
        return $this->getUncompressedAddress($compressed, $derPubKey);
    }
     ...
     * set a private key.
     *
     * @param string $bigNumberStr (for example '1234567890123456789012345678901234567890 ...')
     * 
     */
     ...
     * @throws \Exception
     */
    public function getWif($compressed = false)
    {
        if(!isset($this->k))
        {
            throw new \Exception('No Private Key was defined');
